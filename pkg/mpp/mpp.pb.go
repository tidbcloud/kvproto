...
type TaskMeta struct {
	...
	//	*TaskMeta_KeyspaceId
	//	*TaskMeta_KeyspaceIdentity
	Keyspace               isTaskMeta_Keyspace `protobuf_oneof:"keyspace"`
...
type isTaskMeta_Keyspace interface {
	isTaskMeta_Keyspace()
	MarshalTo([]byte) (int, error)
	Size() int
}

type TaskMeta_KeyspaceId struct {
	KeyspaceId uint32 `protobuf:"varint,10,opt,name=keyspace_id,json=keyspaceId,proto3,oneof" json:"keyspace_id,omitempty"`
}
type TaskMeta_KeyspaceIdentity struct {
	KeyspaceIdentity *apipb.KeyspaceIdentity `protobuf:"bytes,22,opt,name=keyspace_identity,json=keyspaceIdentity,proto3,oneof" json:"keyspace_identity,omitempty"`
}

func (*TaskMeta_KeyspaceId) isTaskMeta_Keyspace()       {}
func (*TaskMeta_KeyspaceIdentity) isTaskMeta_Keyspace() {}

func (m *TaskMeta) GetKeyspace() isTaskMeta_Keyspace {
	if m != nil {
		return m.Keyspace
	}
	return nil
...
func (m *TaskMeta) GetKeyspaceId() uint32 {
	if x, ok := m.GetKeyspace().(*TaskMeta_KeyspaceId); ok {
		return x.KeyspaceId
	}
	return 0
}
...
func (m *TaskMeta) GetKeyspaceIdentity() *apipb.KeyspaceIdentity {
	if x, ok := m.GetKeyspace().(*TaskMeta_KeyspaceIdentity); ok {
...
func (*TaskMeta) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TaskMeta_KeyspaceId)(nil),
		(*TaskMeta_KeyspaceIdentity)(nil),
	}
}
...
var fileDescriptor_819623c7fa76fc55 = []byte{
	...
	,
}
...
func (m *TaskMeta_KeyspaceId) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TaskMeta_KeyspaceId) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *TaskMeta_KeyspaceIdentity) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TaskMeta_KeyspaceIdentity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *TaskMeta_KeyspaceId) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TaskMeta_KeyspaceIdentity) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TaskMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.Keyspace = &TaskMeta_KeyspaceId{v}
		case 11:
			if wireType != 2 {
		...
		case 22:
			...
			m.Keyspace = &TaskMeta_KeyspaceIdentity{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
