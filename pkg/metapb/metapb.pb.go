...
type Store struct {
	...
	// Secure address provides the secure service for client.
	SecureAddress string `protobuf:"bytes,30,opt,name=secure_address,json=secureAddress,proto3" json:"secure_address,omitempty"`
...
func (m *Store) GetSecureAddress() string {
	if m != nil {
		return m.SecureAddress
	}
	return ""
}
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Store) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SecureAddress) > 0 {
		i -= len(m.SecureAddress)
		copy(dAtA[i:], m.SecureAddress)
		i = encodeVarintMetapb(dAtA, i, uint64(len(m.SecureAddress)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf2
...
func (m *Store) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecureAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecureAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetapb(dAtA[iNdEx:])
