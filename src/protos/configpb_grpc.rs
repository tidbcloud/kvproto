...
const METHOD_CONFIG_GET_ALL: ::grpcio::Method<super::configpb::GetAllRequest, super::configpb::GetAllResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/configpb.Config/GetAll",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl ConfigClient {
    ...
    pub fn get_all_opt(&self, req: &super::configpb::GetAllRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::configpb::GetAllResponse> {
        self.client.unary_call(&METHOD_CONFIG_GET_ALL, req, opt)
    }

    pub fn get_all(&self, req: &super::configpb::GetAllRequest) -> ::grpcio::Result<super::configpb::GetAllResponse> {
        self.get_all_opt(req, ::grpcio::CallOption::default())
    }

    pub fn get_all_async_opt(&self, req: &super::configpb::GetAllRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::configpb::GetAllResponse>> {
        self.client.unary_call_async(&METHOD_CONFIG_GET_ALL, req, opt)
    }

    pub fn get_all_async(&self, req: &super::configpb::GetAllRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::configpb::GetAllResponse>> {
        self.get_all_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub fn create_config<S: Config + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_CONFIG_GET_ALL, move |ctx, req, resp| {
        instance.get_all(ctx, req, resp)
    });
    let mut instance = s.clone();
