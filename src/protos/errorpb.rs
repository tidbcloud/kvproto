...
impl<'a> ::std::default::Default for &'a IsWitness {
    fn default() -> &'a IsWitness {
        <IsWitness as ::protobuf::Message>::default_instance()
    }
}

impl IsWitness {
    pub fn new() -> IsWitness {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for IsWitness {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn default_instance() -> &'static IsWitness {
        static mut instance: ::protobuf::lazy::Lazy<IsWitness> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const IsWitness,
        };
        unsafe {
            instance.get(IsWitness::new)
        }
    }
}

impl ::protobuf::Clear for IsWitness {
    fn clear(&mut self) {
        self.region_id = 0;
        self.unknown_fields.clear();
    }
...
impl ::protobuf::PbPrint for IsWitness {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::std::fmt::Debug for IsWitness {
    #[allow(unused_variables)]
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
        ::protobuf::PbPrint::fmt(&self.region_id, "region_id", &mut s);
...
impl ::protobuf::reflect::ProtobufValue for IsWitness {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl ServerIsBusy {
    ...
    pub fn get_estimated_wait_ms(&self) -> u32 {
        self.estimated_wait_ms
    }
    pub fn clear_estimated_wait_ms(&mut self) {
        self.estimated_wait_ms = 0;
    }

    // Param is passed by value, moved
    pub fn set_estimated_wait_ms(&mut self, v: u32) {
        self.estimated_wait_ms = v;
    }
...
impl ::protobuf::Message for ServerIsBusy {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.estimated_wait_ms != 0 {
            my_size += ::protobuf::rt::value_size(3, self.estimated_wait_ms, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.applied_index != 0 {
            my_size += ::protobuf::rt::value_size(4, self.applied_index, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.estimated_wait_ms != 0 {
            os.write_uint32(3, self.estimated_wait_ms)?;
        }
        if self.applied_index != 0 {
            os.write_uint64(4, self.applied_index)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for ServerIsBusy {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.estimated_wait_ms, "estimated_wait_ms", buf);
...
impl ::std::fmt::Debug for ServerIsBusy {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.estimated_wait_ms, "estimated_wait_ms", &mut s);
...
impl FlashbackInProgress {
    ...
    pub fn get_flashback_start_ts(&self) -> u64 {
        self.flashback_start_ts
    }
    pub fn clear_flashback_start_ts(&mut self) {
        self.flashback_start_ts = 0;
    }

    // Param is passed by value, moved
    pub fn set_flashback_start_ts(&mut self, v: u64) {
        self.flashback_start_ts = v;
    }
}
...
impl ::protobuf::Message for FlashbackInProgress {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.flashback_start_ts != 0 {
            my_size += ::protobuf::rt::value_size(2, self.flashback_start_ts, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.flashback_start_ts != 0 {
            os.write_uint64(2, self.flashback_start_ts)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for FlashbackInProgress {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        let old_len = buf.len();
        ::protobuf::PbPrint::fmt(&self.region_id, "region_id", buf);
        ::protobuf::PbPrint::fmt(&self.flashback_start_ts, "flashback_start_ts", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for FlashbackInProgress {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
        ::protobuf::PbPrint::fmt(&self.region_id, "region_id", &mut s);
        ::protobuf::PbPrint::fmt(&self.flashback_start_ts, "flashback_start_ts", &mut s);
        write!(f, "{}", s)
    }
}
...
impl<'a> ::std::default::Default for &'a FlashbackNotPrepared {
    fn default() -> &'a FlashbackNotPrepared {
        <FlashbackNotPrepared as ::protobuf::Message>::default_instance()
    }
}

impl FlashbackNotPrepared {
    pub fn new() -> FlashbackNotPrepared {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for FlashbackNotPrepared {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> FlashbackNotPrepared {
        FlashbackNotPrepared::new()
    }

    fn default_instance() -> &'static FlashbackNotPrepared {
        static mut instance: ::protobuf::lazy::Lazy<FlashbackNotPrepared> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const FlashbackNotPrepared,
        };
        unsafe {
            instance.get(FlashbackNotPrepared::new)
        }
    }
}

impl ::protobuf::Clear for FlashbackNotPrepared {
    fn clear(&mut self) {
        self.region_id = 0;
        self.unknown_fields.clear();
    }
...
impl ::protobuf::PbPrint for FlashbackNotPrepared {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::std::fmt::Debug for FlashbackNotPrepared {
    #[allow(unused_variables)]
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
        ::protobuf::PbPrint::fmt(&self.region_id, "region_id", &mut s);
...
impl ::protobuf::reflect::ProtobufValue for FlashbackNotPrepared {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
pub struct Error {
    ...
    pub flashback_not_prepared: ::protobuf::SingularPtrField<FlashbackNotPrepared>,
    pub is_witness: ::protobuf::SingularPtrField<IsWitness>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Error {
    ...
    // .errorpb.FlashbackNotPrepared FlashbackNotPrepared = 18;


    pub fn get_flashback_not_prepared(&self) -> &FlashbackNotPrepared {
        self.flashback_not_prepared.as_ref().unwrap_or_else(|| FlashbackNotPrepared::default_instance())
    }
    pub fn clear_flashback_not_prepared(&mut self) {
        self.flashback_not_prepared.clear();
    }

    pub fn has_flashback_not_prepared(&self) -> bool {
        self.flashback_not_prepared.is_some()
    }

    // Param is passed by value, moved
    pub fn set_flashback_not_prepared(&mut self, v: FlashbackNotPrepared) {
        self.flashback_not_prepared = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_flashback_not_prepared(&mut self) -> &mut FlashbackNotPrepared {
        if self.flashback_not_prepared.is_none() {
            self.flashback_not_prepared.set_default();
        }
        self.flashback_not_prepared.as_mut().unwrap()
    }

    // Take field
    pub fn take_flashback_not_prepared(&mut self) -> FlashbackNotPrepared {
        self.flashback_not_prepared.take().unwrap_or_else(|| FlashbackNotPrepared::new())
    }

    // .errorpb.IsWitness is_witness = 19;


    pub fn get_is_witness(&self) -> &IsWitness {
        self.is_witness.as_ref().unwrap_or_else(|| IsWitness::default_instance())
    }
    pub fn clear_is_witness(&mut self) {
        self.is_witness.clear();
    }

    pub fn has_is_witness(&self) -> bool {
        self.is_witness.is_some()
    }

    // Param is passed by value, moved
    pub fn set_is_witness(&mut self, v: IsWitness) {
        self.is_witness = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_is_witness(&mut self) -> &mut IsWitness {
        if self.is_witness.is_none() {
            self.is_witness.set_default();
        }
        self.is_witness.as_mut().unwrap()
    }

    // Take field
    pub fn take_is_witness(&mut self) -> IsWitness {
        self.is_witness.take().unwrap_or_else(|| IsWitness::new())
    }
}
...
impl ::protobuf::Message for Error {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.flashback_not_prepared {
            if !v.is_initialized() {
                return false;
            }
        };
        for v in &self.is_witness {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                18 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.flashback_not_prepared)?;
                },
                19 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.is_witness)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.flashback_not_prepared.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if let Some(ref v) = self.is_witness.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
...
impl ::protobuf::PbPrint for Error {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.flashback_not_prepared, "flashback_not_prepared", buf);
...
impl ::std::fmt::Debug for Error {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.flashback_not_prepared, "flashback_not_prepared", &mut s);
