...
pub struct Request {
    ...
    pub paging_size: u64,
    pub tasks: ::protobuf::RepeatedField<StoreBatchTask>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Request {
    ...
    // repeated .coprocessor.StoreBatchTask tasks = 11;


    pub fn get_tasks(&self) -> &[StoreBatchTask] {
        &self.tasks
    }
    ...
    // Param is passed by value, moved
    pub fn set_tasks(&mut self, v: ::protobuf::RepeatedField<StoreBatchTask>) {
        self.tasks = v;
    }

    // Mutable pointer to the field.
    pub fn mut_tasks(&mut self) -> &mut ::protobuf::RepeatedField<StoreBatchTask> {
        &mut self.tasks
    }

    // Take field
    pub fn take_tasks(&mut self) -> ::protobuf::RepeatedField<StoreBatchTask> {
...
impl ::protobuf::PbPrint for Request {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.tasks, "tasks", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Request {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.tasks, "tasks", &mut s);
        write!(f, "{}", s)
    }
}
...
pub struct Response {
    ...
    pub batch_responses: ::protobuf::RepeatedField<StoreBatchTaskResponse>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Response {
    ...
    // repeated .coprocessor.StoreBatchTaskResponse batch_responses = 13;


    pub fn get_batch_responses(&self) -> &[StoreBatchTaskResponse] {
        &self.batch_responses
    }
    pub fn clear_batch_responses(&mut self) {
        self.batch_responses.clear();
    }

    // Param is passed by value, moved
    pub fn set_batch_responses(&mut self, v: ::protobuf::RepeatedField<StoreBatchTaskResponse>) {
        self.batch_responses = v;
    }

    // Mutable pointer to the field.
    pub fn mut_batch_responses(&mut self) -> &mut ::protobuf::RepeatedField<StoreBatchTaskResponse> {
        &mut self.batch_responses
    }

    // Take field
    pub fn take_batch_responses(&mut self) -> ::protobuf::RepeatedField<StoreBatchTaskResponse> {
        ::std::mem::replace(&mut self.batch_responses, ::protobuf::RepeatedField::new())
    }
}
...
impl ::protobuf::Message for Response {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.batch_responses)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.batch_responses {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
...
impl ::protobuf::PbPrint for Response {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.batch_responses, "batch_responses", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for Response {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.batch_responses, "batch_responses", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ::protobuf::Message for BatchRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                8 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.log_id)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.log_id.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.log_id);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
...
impl ::protobuf::PbPrint for BatchRequest {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.log_id, "log_id", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for BatchRequest {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.log_id, "log_id", &mut s);
        write!(f, "{}", s)
    }
}
...
impl<'a> ::std::default::Default for &'a StoreBatchTask {
    fn default() -> &'a StoreBatchTask {
        <StoreBatchTask as ::protobuf::Message>::default_instance()
    }
}

impl StoreBatchTask {
    pub fn new() -> StoreBatchTask {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for StoreBatchTask {
    fn is_initialized(&self) -> bool {
        for v in &self.region_epoch {
            if !v.is_initialized() {
                return false;
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.task_id != 0 {
            my_size += ::protobuf::rt::value_size(5, self.task_id, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.task_id != 0 {
            os.write_uint64(5, self.task_id)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> StoreBatchTask {
        StoreBatchTask::new()
    }

    fn default_instance() -> &'static StoreBatchTask {
        static mut instance: ::protobuf::lazy::Lazy<StoreBatchTask> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const StoreBatchTask,
        };
        unsafe {
            instance.get(StoreBatchTask::new)
        }
    }
}

impl ::protobuf::Clear for StoreBatchTask {
    fn clear(&mut self) {
        self.region_id = 0;
        self.region_epoch.clear();
        self.peer.clear();
...
impl ::protobuf::PbPrint for StoreBatchTask {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::std::fmt::Debug for StoreBatchTask {
    #[allow(unused_variables)]
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
        ::protobuf::PbPrint::fmt(&self.region_id, "region_id", &mut s);
...
impl ::protobuf::reflect::ProtobufValue for StoreBatchTask {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a StoreBatchTaskResponse {
    fn default() -> &'a StoreBatchTaskResponse {
        <StoreBatchTaskResponse as ::protobuf::Message>::default_instance()
    }
}

impl StoreBatchTaskResponse {
    pub fn new() -> StoreBatchTaskResponse {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for StoreBatchTaskResponse {
    fn is_initialized(&self) -> bool {
        for v in &self.region_error {
            if !v.is_initialized() {
                return false;
    ...
    fn new() -> StoreBatchTaskResponse {
        StoreBatchTaskResponse::new()
    }

    fn default_instance() -> &'static StoreBatchTaskResponse {
        static mut instance: ::protobuf::lazy::Lazy<StoreBatchTaskResponse> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const StoreBatchTaskResponse,
        };
        unsafe {
            instance.get(StoreBatchTaskResponse::new)
        }
    }
}

impl ::protobuf::Clear for StoreBatchTaskResponse {
    fn clear(&mut self) {
        self.data.clear();
        self.region_error.clear();
        self.locked.clear();
...
impl ::protobuf::PbPrint for StoreBatchTaskResponse {
    #[allow(unused_variables)]
    fn fmt(&self, name: &str, buf: &mut String) {
        ::protobuf::push_message_start(name, buf);
        let old_len = buf.len();
...
impl ::std::fmt::Debug for StoreBatchTaskResponse {
    #[allow(unused_variables)]
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut s = String::new();
        ::protobuf::PbPrint::fmt(&self.data, "data", &mut s);
...
impl ::protobuf::reflect::ProtobufValue for StoreBatchTaskResponse {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
