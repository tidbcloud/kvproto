...
impl EventRow {
    ...
    pub fn get_txn_source(&self) -> u64 {
        self.txn_source
    }
    pub fn clear_txn_source(&mut self) {
        self.txn_source = 0;
    }

    // Param is passed by value, moved
    pub fn set_txn_source(&mut self, v: u64) {
        self.txn_source = v;
    }
}
...
impl ::protobuf::Message for EventRow {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.txn_source != 0 {
            my_size += ::protobuf::rt::value_size(9, self.txn_source, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.txn_source != 0 {
            os.write_uint64(9, self.txn_source)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for EventRow {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.txn_source, "txn_source", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for EventRow {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.txn_source, "txn_source", &mut s);
        write!(f, "{}", s)
    }
}
...
impl ChangeDataRequest {
    ...
    pub fn clear_filter_loop(&mut self) {
        self.filter_loop = false;
    }

    // Param is passed by value, moved
    pub fn set_filter_loop(&mut self, v: bool) {
        self.filter_loop = v;
    }
}
...
impl ::protobuf::Message for ChangeDataRequest {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.filter_loop != false {
            os.write_bool(12, self.filter_loop)?;
        }
        if let ::std::option::Option::Some(ref v) = self.request {
            match v {
                &ChangeDataRequest_oneof_request::Register(ref v) => {
...
impl ::protobuf::PbPrint for ChangeDataRequest {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.filter_loop, "filter_loop", buf);
        ::protobuf::PbPrint::fmt(&self.request, "request", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
...
impl ::std::fmt::Debug for ChangeDataRequest {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.filter_loop, "filter_loop", &mut s);
        ::protobuf::PbPrint::fmt(&self.request, "request", &mut s);
        write!(f, "{}", s)
    }
}
