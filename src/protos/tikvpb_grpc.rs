...
pub trait Tikv {
    ...
    fn kv_prepare_flashback_to_version(&mut self, ctx: ::grpcio::RpcContext, _req: super::kvrpcpb::PrepareFlashbackToVersionRequest, sink: ::grpcio::UnarySink<super::kvrpcpb::PrepareFlashbackToVersionResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
