...
const METHOD_TIKV_KV_PREPARE_FLASHBACK_TO_VERSION: ::grpcio::Method<super::kvrpcpb::PrepareFlashbackToVersionRequest, super::kvrpcpb::PrepareFlashbackToVersionResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/tikvpb.Tikv/KvPrepareFlashbackToVersion",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
const METHOD_TIKV_DELEGATE_COPROCESSOR: ::grpcio::Method<super::coprocessor::DelegateRequest, super::coprocessor::DelegateResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/tikvpb.Tikv/DelegateCoprocessor",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl TikvClient {
    ...
    pub fn kv_prepare_flashback_to_version_opt(&self, req: &super::kvrpcpb::PrepareFlashbackToVersionRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::kvrpcpb::PrepareFlashbackToVersionResponse> {
        self.client.unary_call(&METHOD_TIKV_KV_PREPARE_FLASHBACK_TO_VERSION, req, opt)
    }

    pub fn kv_prepare_flashback_to_version(&self, req: &super::kvrpcpb::PrepareFlashbackToVersionRequest) -> ::grpcio::Result<super::kvrpcpb::PrepareFlashbackToVersionResponse> {
        self.kv_prepare_flashback_to_version_opt(req, ::grpcio::CallOption::default())
    }

    pub fn kv_prepare_flashback_to_version_async_opt(&self, req: &super::kvrpcpb::PrepareFlashbackToVersionRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::kvrpcpb::PrepareFlashbackToVersionResponse>> {
        self.client.unary_call_async(&METHOD_TIKV_KV_PREPARE_FLASHBACK_TO_VERSION, req, opt)
    }

    pub fn kv_prepare_flashback_to_version_async(&self, req: &super::kvrpcpb::PrepareFlashbackToVersionRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::kvrpcpb::PrepareFlashbackToVersionResponse>> {
        self.kv_prepare_flashback_to_version_async_opt(req, ::grpcio::CallOption::default())
    }
    ...
    pub fn delegate_coprocessor_opt(&self, req: &super::coprocessor::DelegateRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::coprocessor::DelegateResponse> {
        self.client.unary_call(&METHOD_TIKV_DELEGATE_COPROCESSOR, req, opt)
    }

    pub fn delegate_coprocessor(&self, req: &super::coprocessor::DelegateRequest) -> ::grpcio::Result<super::coprocessor::DelegateResponse> {
        self.delegate_coprocessor_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delegate_coprocessor_async_opt(&self, req: &super::coprocessor::DelegateRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::coprocessor::DelegateResponse>> {
        self.client.unary_call_async(&METHOD_TIKV_DELEGATE_COPROCESSOR, req, opt)
    }

    pub fn delegate_coprocessor_async(&self, req: &super::coprocessor::DelegateRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::coprocessor::DelegateResponse>> {
        self.delegate_coprocessor_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait Tikv {
    ...
    fn kv_prepare_flashback_to_version(&mut self, ctx: ::grpcio::RpcContext, req: super::kvrpcpb::PrepareFlashbackToVersionRequest, sink: ::grpcio::UnarySink<super::kvrpcpb::PrepareFlashbackToVersionResponse>);
    fn kv_flashback_to_version(&mut self, ctx: ::grpcio::RpcContext, req: super::kvrpcpb::FlashbackToVersionRequest, sink: ::grpcio::UnarySink<super::kvrpcpb::FlashbackToVersionResponse>);
    ...
    fn delegate_coprocessor(&mut self, ctx: ::grpcio::RpcContext, req: super::coprocessor::DelegateRequest, sink: ::grpcio::UnarySink<super::coprocessor::DelegateResponse>);
    ...
    fn get_lock_wait_history(&mut self, ctx: ::grpcio::RpcContext, req: super::kvrpcpb::GetLockWaitHistoryRequest, sink: ::grpcio::UnarySink<super::kvrpcpb::GetLockWaitHistoryResponse>);
}
...
pub fn create_tikv<S: Tikv + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_TIKV_KV_PREPARE_FLASHBACK_TO_VERSION, move |ctx, req, resp| {
        instance.kv_prepare_flashback_to_version(ctx, req, resp)
    });
    let mut instance = s.clone();
    ...
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_TIKV_DELEGATE_COPROCESSOR, move |ctx, req, resp| {
        instance.delegate_coprocessor(ctx, req, resp)
    });
    let mut instance = s.clone();
