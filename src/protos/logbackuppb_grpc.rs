...
const METHOD_LOG_BACKUP_SUBSCRIBE_FLUSH_EVENT: ::grpcio::Method<super::logbackuppb::SubscribeFlushEventRequest, super::logbackuppb::SubscribeFlushEventResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::ServerStreaming,
    name: "/logbackup.LogBackup/SubscribeFlushEvent",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl LogBackupClient {
    ...
    pub fn subscribe_flush_event_opt(&self, req: &super::logbackuppb::SubscribeFlushEventRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientSStreamReceiver<super::logbackuppb::SubscribeFlushEventResponse>> {
        self.client.server_streaming(&METHOD_LOG_BACKUP_SUBSCRIBE_FLUSH_EVENT, req, opt)
    }

    pub fn subscribe_flush_event(&self, req: &super::logbackuppb::SubscribeFlushEventRequest) -> ::grpcio::Result<::grpcio::ClientSStreamReceiver<super::logbackuppb::SubscribeFlushEventResponse>> {
        self.subscribe_flush_event_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait LogBackup {
    ...
    fn subscribe_flush_event(&mut self, ctx: ::grpcio::RpcContext, _req: super::logbackuppb::SubscribeFlushEventRequest, sink: ::grpcio::ServerStreamingSink<super::logbackuppb::SubscribeFlushEventResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
}
...
pub fn create_log_backup<S: LogBackup + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s;
    builder = builder.add_server_streaming_handler(&METHOD_LOG_BACKUP_SUBSCRIBE_FLUSH_EVENT, move |ctx, req, resp| {
        instance.subscribe_flush_event(ctx, req, resp)
    });
    builder.build()
}
