...
pub trait LogBackup {
    ...
    fn subscribe_flush_event(&mut self, ctx: ::grpcio::RpcContext, req: super::logbackuppb::SubscribeFlushEventRequest, sink: ::grpcio::ServerStreamingSink<super::logbackuppb::SubscribeFlushEventResponse>);
}
