...
pub struct BackupRequest {
    ...
    pub sub_ranges: ::protobuf::RepeatedField<super::kvrpcpb::KeyRange>,
...
impl BackupRequest {
    ...
    pub fn get_sub_ranges(&self) -> &[super::kvrpcpb::KeyRange] {
        &self.sub_ranges
    }
    ...
    // Param is passed by value, moved
    pub fn set_sub_ranges(&mut self, v: ::protobuf::RepeatedField<super::kvrpcpb::KeyRange>) {
        self.sub_ranges = v;
    }

    // Mutable pointer to the field.
    pub fn mut_sub_ranges(&mut self) -> &mut ::protobuf::RepeatedField<super::kvrpcpb::KeyRange> {
        &mut self.sub_ranges
    }

    // Take field
    pub fn take_sub_ranges(&mut self) -> ::protobuf::RepeatedField<super::kvrpcpb::KeyRange> {
        ::std::mem::replace(&mut self.sub_ranges, ::protobuf::RepeatedField::new())
    }
...
impl ::protobuf::Message for BackupRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                16 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.sub_ranges)?;
                },
                17 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.replica_read != false {
            os.write_bool(17, self.replica_read)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for BackupRequest {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.sub_ranges, "sub_ranges", buf);
...
impl ::std::fmt::Debug for BackupRequest {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.sub_ranges, "sub_ranges", &mut s);
...
impl S3 {
    ...
    pub fn take_session_token(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.session_token, ::std::string::String::new())
    }
}
...
impl ::protobuf::Message for S3 {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                15 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.session_token)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.session_token.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.session_token);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.session_token.is_empty() {
            os.write_string(15, &self.session_token)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for S3 {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.session_token, "session_token", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for S3 {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.session_token, "session_token", &mut s);
        write!(f, "{}", s)
    }
}
